...
export class AddressPipe implements PipeTransform {
  ...
  transform(value?: ConfirmationToken['shipping'] | ShippingAddress, ...args: unknown[]): unknown { //Destructuring — pulls each property out of value.address into its own standalone variable, so you don't have to write value.address.line1, value.address.city, etc. repeatedly below.
